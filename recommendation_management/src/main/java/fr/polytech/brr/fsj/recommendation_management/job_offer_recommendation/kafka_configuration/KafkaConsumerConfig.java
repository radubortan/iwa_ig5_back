...
public class KafkaConsumerConfig {
    ...
    public Map<String, Object> consumerConfig(){
        ...
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JobOfferDeserializer.class);
        return props;
    }
    ...
    public KafkaListenerContainerFactory<
            ConcurrentMessageListenerContainer<String,JobOffer>> factory (
                    ConsumerFactory<String, JobOffer> consumerFactory
            ){
